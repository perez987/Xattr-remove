...
Xcode service is not stored as a separate file. It's defined in the app's `Info.plist` and registered with macOS when the app runs. The service cache is stored by macOS at
